...
@pytest.mark.parametrize("sql", (
    ...
    pytest.param("SELECT column1 FROM table1", id="select_column_expr_single"),
    pytest.param("SELECT column1, column2 FROM table1", id="select_column_expr_multi"),
    pytest.param("SELECT column1, column2 FROM table1, table2", id="select_from_multi"),
    pytest.param("SELECT column1 AS alias1 FROM table1", id="select_column_expr_alias_explicit"),
    pytest.param("SELECT column1 alias1 FROM table1", id="select_column_expr_alias_implicit"),
